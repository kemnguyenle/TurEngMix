#!/bin/bash
# =============================================================================
# Encoder fine-tuning  —  LID  —  TurkishBERTweet (VRLLab/TurkishBERTweet)
# =============================================================================
#
# TurkishBERTweet is a RoBERTa-base variant (~125 M params).
# Resource profile identical to the other LID encoder jobs.
#
# PREREQUISITE: run 01_prepare_dataset.py once (see encoder_lid_berturk.sh).
# =============================================================================

#SBATCH --job-name=lid_twbert
#SBATCH --account=clip
...
MODEL_OUT="/fs/nexus-scratch/nlpa/models/turkishbertweet_lid"
