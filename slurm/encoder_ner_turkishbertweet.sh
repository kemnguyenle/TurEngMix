#!/bin/bash
# =============================================================================
# Encoder fine-tuning  —  NER  —  TurkishBERTweet (VRLLab/TurkishBERTweet)
# =============================================================================
#
# PREREQUISITE: run NER 01_prepare_dataset.py once (see encoder_ner_berturk.sh).
# =============================================================================

#SBATCH --job-name=ner_twbert
#SBATCH --account=clip
...
MODEL_OUT="/fs/nexus-scratch/nlpa/models/turkishbertweet_ner"
